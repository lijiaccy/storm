...
public class MobileBolt2 extends BaseRichBolt {
//        Logger logger = Logger.getLogger(MobileBolt2.class);
    private static final Logger logger =   Logger.getLogger(MobileBolt2.class);
        private Map conf;
        ...
        public void prepare(Map conf, TopologyContext context, OutputCollector collector) {
            logger.info("MobileBolt2准备");
            this.conf = conf;
            this.context = context;
            this.collector = collector;
            if (map.size() == 0){
                map = JedisUtil.getpip("mobile");
