...
public class UnicomSpout extends BaseRichSpout implements Serializable {
//    Logger logger = Logger.getLogger(MobileSpout.class);
private static final Logger logger =   Logger.getLogger(UnicomSpout.class);
    ...
    String des = PropertiesUtil.getString(prop, "unicom.des");
    SpoutOutputCollector collector;

    public UnicomSpout() throws IOException, URISyntaxException {
    }
